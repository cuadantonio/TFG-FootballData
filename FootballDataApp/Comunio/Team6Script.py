...
team = "Cadiz"
url = "https://www.comuniazo.com/comunio-apuestas/equipos/cadiz"
...
for eachPlayer in allPlayers:
    ...
    if(len(nicknameList)!=1):
        ...
        if query2 != None:
            ...
            continue
        nicknameAux2 = nicknameList[0]
        query3 = comunio.find_one(
            {"name": {"$regex": re.compile(nicknameAux2, re.IGNORECASE)}, "team": team, "comunioFound": False})
        if query3 != None:
