...
team = "Espanyol"
url = "https://www.comuniazo.com/comunio-apuestas/equipos/espanyol"
...
for eachPlayer in allPlayers:
    ...
    if(len(nicknameList)!=1):
        ...
        query3 = comunio.find_one({"name": {"$regex": re.compile(playerFirstname, re.IGNORECASE)}, "team": team,"comunioFound":False})
        if query3 != None:
