...
localFixtures = matches.find({"homeTeamId":723})
for fixture in localFixtures:
    localFixturesIds.append(fixture['fixtureId'])

awayFixtures = matches.find({"awayTeamId":723})
...
for localFixtureId in localFixturesIds:
    ...
    localFixtureToAdd = {"fixtureId":localFixtureId,"round":round,"teamId":id,"teamName":team,"side":"Home", "rivalTeam":rivalTeam,"rivalTeamId":rivalTeamId,
                         "score":score,"shotsOnGoal":shotsOnGoal,"shotsOffGoal":shotsOffGoal,"totalShots":totalShots,"blockedShots":blockedShots,
                         "shotsInsidebox":shotsInsidebox,"shotsOutsidebox":shotsOutsidebox,"fouls":fouls,"corners":corners,
                         "offsides":offsides,"ballPossession":ballPossession,"yellowCards":yellowCards,"redCards":redCards,
                         "goalkeeperSaves":goalkeeperSaves,"totalPasses":totalPasses,"passesAccurate":passesAccurate,
...
for awayFixtureId in awayFixturesIds:
    ...
    if winnerLocal == True:
        ...
        winnerId = id
    awayFixtureToAdd = {"fixtureId":awayFixtureId,"round":round,"teamId":id,"teamName":team,"side":"Away", "rivalTeam":rivalTeam,"rivalTeamId":rivalTeamId,
                         "score":score,"shotsOnGoal":shotsOnGoal,"shotsOffGoal":shotsOffGoal,"totalShots":totalShots,"blockedShots":blockedShots,
                         "shotsInsidebox":shotsInsidebox,"shotsOutsidebox":shotsOutsidebox,"fouls":fouls,"corners":corners,
                         "offsides":offsides,"ballPossession":ballPossession,"yellowCards":yellowCards,"redCards":redCards,
                         "goalkeeperSaves":goalkeeperSaves,"totalPasses":totalPasses,"passesAccurate":passesAccurate,
